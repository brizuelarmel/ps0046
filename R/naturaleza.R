...
#'   \item{STAI1_neg}{Pre-intervention (T1) STAI negative affect composite.
#'     Mean of three items (upset, tense, worried) rated on a 1-4 scale.
#'     Higher scores indicate greater negative affect.}
#'   \item{mood1_happy}{Pre-intervention (T1) VAS rating for happiness.
#'     Scale from 0 to 100.}
#'   \item{mood1_sad}{Pre-intervention (T1) VAS rating for sadness.
#'     Scale from 0 to 100.}
#'   \item{mood1_inspired}{Pre-intervention (T1) VAS rating for inspiration.
#'     Scale from 0 to 100.}
#'   \item{mood1_angry}{Pre-intervention (T1) VAS rating for anger.
#'     Scale from 0 to 100.}
#'   \item{STAI2_pos}{Post-intervention (T2) STAI positive affect composite.
#'     Mean of three items (calm, relaxed, content) rated on a 1-4 scale.}
#'   \item{STAI2_neg}{Post-intervention (T2) STAI negative affect composite.
#'     Mean of three items (upset, tense, worried) rated on a 1-4 scale.}
#'   \item{mood2_happy}{Post-intervention (T2) VAS rating for happiness.
#'     Scale from 0 to 100.}
#'   \item{mood2_sad}{Post-intervention (T2) VAS rating for sadness.
#'     Scale from 0 to 100.}
#'   \item{mood2_inspired}{Post-intervention (T2) VAS rating for inspiration.
#'     Scale from 0 to 100.}
